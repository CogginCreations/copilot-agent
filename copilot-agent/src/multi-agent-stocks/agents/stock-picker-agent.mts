...
export const stockPickerAgent: WorkflowAgent = {
    ...
    prompt:
        "Respond only with a list of 3-8 stock ideas including ticker, thesis, and optional catalyst that reflect the provided prompt. Return JSON with a single picks array.",
