...
export const stockPickerAgent = {
    name: "stock-picker",
    model: "gpt-4.1-mini",
    displayName: "Stock Picker",
    description: "Assembles stock ideas that match the prompt without performing risk oversight",
    prompt: "Respond only with a list of 3-8 stock ideas including ticker, thesis, and optional catalyst that reflect the provided prompt. Return JSON with a single picks array.",
